...
image_mae = Image.open('day_mae.jpg')
image_rmse = Image.open('day_rmse.jpg')
image_mse = Image.open('day_mse.jpg')
...
if selected_status_6 == 'GRU':
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(range_future, np.array(prediction1),label='Forecasted with GRU',linewidth=3)
...
# #=======================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(np.arange(range_history), np.array(history), label='History',linewidth=3)
        plt.plot(range_future, np.array(prediction1),label='Forecasted with Bi-LSTM',linewidth=3)
        plt.legend(loc='upper right',fontsize=20)
        plt.xlabel('Time step(days)',fontsize=24)
        plt.ylabel('EV charging demand(Total_kwh)',fontsize=24)
        plt.xticks(fontsize=20)
...
# ===========================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        range_future = list(range(range_history, range_history + len(prediction1)))
        plt.plot(np.arange(range_history), np.array(history), label='History',linewidth=3)
        plt.plot(range_future, np.array(prediction1),label='Forecasted with CNN-LSTM',linewidth=3)
        plt.legend(loc='upper right',fontsize=20)
        plt.xlabel('Time step(days)',fontsize=24)
        plt.ylabel('EV charging demand(Total_kwh)',fontsize=24)
        plt.xticks(fontsize=20)
...
#=================================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        range_future = list(range(range_history, range_history + len(prediction1)))
        plt.plot(np.arange(range_history), np.array(history), label='History',linewidth=3)
        plt.plot(range_future, np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.legend(loc='upper right',fontsize=20)
        plt.xlabel('Time step(days)',fontsize=24)
        plt.ylabel('EV charging demand(Total_kwh)',fontsize=24)
        plt.xticks(fontsize=20)
...
#=================================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        range_future = list(range(range_history, range_history + len(prediction1)))
        plt.plot(np.arange(range_history), np.array(history), label='History',linewidth=3)
        plt.plot(range_future, np.array(prediction1),label='Forecasted with XGBoost',linewidth=3)
        plt.legend(loc='upper right',fontsize=20)
        plt.xlabel('Time step(days)',fontsize=24)
        plt.ylabel('EV charging demand(Total_kwh)',fontsize=24)
        plt.xticks(fontsize=20)
